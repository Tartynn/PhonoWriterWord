...
//                    SQLiteCommand paramLanguageId = new SQLiteCommand("languageId", db);
//                    SQLiteCommand paramDefinitionId = new SQLiteCommand("definitionId", db);
//                    SQLiteCommand paramImageId = new SQLiteCommand("imageId", db);
//                    SQLiteCommand paramText = new SQLiteCommand("text", db);
//                    SQLiteCommand paramOccurrence = new SQLiteCommand("occurrence", db);
//                    SQLiteCommand paramFuzzyHash = new SQLiteCommand("fuzzy_hash", db);
//                    SQLiteCommand paramPhonetic = new SQLiteCommand("phonetic", db);
...
//                    var commandInsert = new SQLiteCommand(insertQuery, db);
//                    SQLiteCommand paramCurrentWordId = new SQLiteCommand("currentWordId", db);
//                    SQLiteCommand paramNextWordId = new SQLiteCommand("nextWordId", db);
//                    SQLiteCommand paramOccurrence = new SQLiteCommand("occurrence", db);
...
//                        var paramWordId = new SQLiteCommand("wordId", db);
//                        var paramText = new SQLiteCommand("text", db);
